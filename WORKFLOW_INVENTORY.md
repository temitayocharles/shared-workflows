...
| `devops-portfolio` | `Build and Push Multi-Arch Docker Image` | `.github/workflows/docker-build-push.yml` | **repo-specific** | Custom multi-stage security/deploy workflow. |
...
| `emergent-lab` | `.github/workflows/ci-cd.yml` | `.github/workflows/ci-cd.yml` | **repo-specific** | Custom multi-stage security/deploy workflow. |
...
| `shared-workflows` | `Baseline Reusable` | `.github/workflows/baseline-reusable.yml` | **repo-specific** | Reusable workflow library definition. |
| `shared-workflows` | `ArgoCD Sync` | `.github/workflows/deploy-argocd.yml` | **repo-specific** | Reusable workflow library definition. |
| `shared-workflows` | `Docker Build & Push` | `.github/workflows/docker-build-push.yml` | **repo-specific** | Reusable workflow library definition. |
| `shared-workflows` | `GitOps Repository Dispatch` | `.github/workflows/gitops-dispatch.yml` | **repo-specific** | Reusable workflow library definition. |
| `shared-workflows` | `Helm Release Bump` | `.github/workflows/helm-release-bump.yml` | **repo-specific** | Reusable workflow library definition. |
| `shared-workflows` | `Render Deploy` | `.github/workflows/render-deploy.yml` | **repo-specific** | Reusable workflow library definition. |
| `shared-workflows` | `Service CI (Go + GHCR)` | `.github/workflows/service-go-ci-ghcr.yml` | **repo-specific** | Reusable workflow library definition. |
| `shared-workflows` | `Service CI (Go Quality + Build)` | `.github/workflows/service-go-quality-build.yml` | **repo-specific** | Reusable workflow library definition. |
| `shared-workflows` | `Service CI (Node + GHCR)` | `.github/workflows/service-node-ci-ghcr.yml` | **repo-specific** | Reusable workflow library definition. |
| `shared-workflows` | `Service CI (Python + GHCR)` | `.github/workflows/service-python-ci-ghcr.yml` | **repo-specific** | Reusable workflow library definition. |
| `shared-workflows` | `Service CI (Python Lint + Unit + Integration Matrix)` | `.github/workflows/service-python-lint-unit-matrix.yml` | **repo-specific** | Reusable workflow library definition. |
| `shared-workflows` | `Go Tests` | `.github/workflows/tests-go.yml` | **repo-specific** | Reusable workflow library definition. |
| `shared-workflows` | `Node Tests` | `.github/workflows/tests-node.yml` | **repo-specific** | Reusable workflow library definition. |
| `shared-workflows` | `Python Tests` | `.github/workflows/tests-python.yml` | **repo-specific** | Reusable workflow library definition. |
| `stack-to-k8s` | `Lab 8 Lite Validation Test` | `.github/workflows/test-lab-8-lite.yml` | **repo-specific** | Custom multi-stage security/deploy workflow. |
...
| `virtual-vacation` | `SonarQube Code Quality & Security Scan` | `.github/workflows/sonarqube-scan.yml` | **repo-specific** | Release/security workflow with provider-specific behavior. |
